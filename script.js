...
document.querySelectorAll('.portfolio-video[data-youtube]').forEach(function(item) {
    ...
    item.addEventListener('click', function() {
        ...
        lightboxContent.innerHTML = '<iframe src="https://www.youtube.com/embed/videoseries?list=' + id + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width:90vw; max-width:900px; height:50.6vw; max-height:506px; border-radius:12px;"></iframe>';
        lightbox.classList.add('active');
        document.body.style.overflow = 'hidden';
    });
});
